...
able to make good predictions on future samples. For example, suppose we fit this complicated curve to a training dataset,
...
from run to run might be consistenly incorrect in certain regions.
